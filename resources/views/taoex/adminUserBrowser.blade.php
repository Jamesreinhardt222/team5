        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="width:100px">
              @if(DB::table('users')->where('id' ,$ranking->id)->select('admin')->value('admin') != 1)<a class="btn btn-outline-danger" style="width:5rem" onclick="return confirm('Are you sure you want to remove this member?')" href="{{ route('deleteUserAdmin', [$ranking->id]) }}">Remove</a>@endif</td>
            @else
