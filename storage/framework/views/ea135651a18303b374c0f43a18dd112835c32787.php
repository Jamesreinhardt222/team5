            ...
            <div id="collapse2" class="panel-collapse collapse show">
              <ul class="list-group">
                <li class="list-group-item" style="overflow:auto">
                  <form method="POST" action="<?php echo e(action('MessageController@sendAdminMessage')); ?>">
                    <?php echo e(csrf_field()); ?>

                    <div class="form-group">
                      <label for="message">New message to user: <?php echo e($id); ?> - <?php echo e($fullname); ?></label>
