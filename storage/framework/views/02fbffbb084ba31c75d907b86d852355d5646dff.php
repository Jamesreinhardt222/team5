      ...
      <table class="table table-striped table-bordered" id="member" style="overflow-x: scroll">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="width:100px"><a class="btn btn-outline-danger" style="width:5rem" onclick="return confirm('Are you sure you want to remove this member?')" href="<?php echo e(route('deleteUserAdmin', [$ranking->id])); ?>">Remove</a></td>
            <?php else: ?>
