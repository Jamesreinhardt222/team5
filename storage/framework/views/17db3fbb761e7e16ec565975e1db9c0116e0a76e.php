  ...
  <div class="container-fluid">
    ...
    <?php if(isset($winnerExist) and $winnerExist == 1): ?>
      ...
      <?php if(isset($createSuccess)): ?>
        <div class="alert alert-success" role="alert" style="margin-top:20px">
          <strong>Match Successfully Recorded!</strong>
          <a class="btn btn-outline-info" href=/home/club>Reload </a> </div> <?php endif; ?> <?php if(isset($createSuccess)): ?> <div class="alert alert-success" role="alert" style="margin-top:20px">
