...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="<?php echo e(route('manageClub')); ?>">Manage Club</a> 
      </li>
            ...
            <div id="collapse2" class="panel-collapse collapse show">
              <ul class="list-group">
                <li class="list-group-item" style="overflow:auto">
                  <form method="POST" action="<?php echo e(action('MessageController@sendClubMemberMessage')); ?>">
                    <?php echo e(csrf_field()); ?>

                    <div class="form-group">
                      <label for="message">New message to club member: <?php echo e($fullname); ?></label>
