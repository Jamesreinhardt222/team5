                ...
                <div class="card mb-3 text-center border-dark bg-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group" style="color:gray">
                            ...
                            <li class="list-group-item" style="font-weight: bold;">League Name: <span style="text-align: right;"><?php echo e(isset($club) ? $club->name : 'No-name'); ?></span></li>
                            
                            <li class="list-group-item" style="font-weight: bold;">League Owner: <span style="text-align: right;"><?php echo e($clubOwner->firstName); ?> <?php echo e($clubOwner->lastName); ?></span></li>
                            ...
                            <li class="list-group-item" style="font-weight: bold;">
                                <a class="btn btn-outline-secondary" style="width:5rem" href="<?php echo e(route('manageClub',$club->id)); ?>">Edit</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="card-body">
                        ...
                        <?php if(Auth::user()->club_owner == 1): ?>
                            ...
                            <form method="POST" action="<?php echo e(action('ClubController@sendMessage')); ?>">
